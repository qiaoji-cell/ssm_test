...
<div class="layui-fluid" style="margin-top: 8px;">
    ...
    <div class="layui-collapse" >
                ...
                <form class="layui-form searchForm" lay-filter="searchForm">
                    ...
                    <div class="layui-container" style="width:35%;display: none">
                        <template id="toolbar">
                            ...
                            <div class="layui-inline" style="margin-left:1200px;">
                                <div class="layui-input-inline">
                                    <button class="layui-btn changeBtn"  lay-event="changeBtn"><i class="layui-icon layui-icon-edit"></i> 申请变更 </button>
                                </div>
                            </div>
                        </template>
                    </div>
        ...
        <div class="layui-panel" style="padding:10px;margin-top:10px;">
            <form lay-filter="changeForm" class="layui-inline layui-form changeForm" >

                <div class="layui-inline">
                    <label class="layui-form-label approval">
                        变更保育费：
                    </label>
                    <div class="layui-input-inline">
                        <select name="oldCareId"  class="layui-select"></select>
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label approval">
                    ...
                    <div class="layui-input-inline">
                        <select name="oldEatId"  class="layui-select"></select>
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label approval">
                    ...
                    <div class="layui-input-inline">
                        <input name="approvalChangeRemark" class="layui-input">
                    </div>
                </div>
            </form>
    ...
    layui.use(['laydate','table','form','jquery','element','laydate'], function(){
        ...
        table.render({
            ...
            cols:[[
                ...
                {field:'approvalEatCare',width:100,title:'变更状态',align:"center",templet:function(d){
                        if(d.approvalEatCare!=null){
                            ...
                            switch (d.approvalEatCare.approvalState){
                                ...
                                case 2:
                                    return '<span class="layui-font-green ">已审批</span>'
                                case 3:
                                    return '<span class="layui-font-red">已驳回</span>'
                            }
                            return
                        }else{
                            return '';
                ...
                {field:'person',width:100,title:'待审批人',align:"center",width: 150,templet:function(d){
                            if(d.approvalEatCare!=null){
                                return d.approvalEatCare.approvalPerson
                            }else{
                                return '';
                            }
                    }},
